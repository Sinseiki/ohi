...
function input_keyboard_layout_info() {
	...
	K3_Semoe_layout = [
		...
		0x002C, /* 0x2C comma: comma */
		0x002D, /* 0x2D minus: minus sign */
		0x011169, /* 0x2E period: virtual jungseong o */
		0x002F, /* 0x2F slash: slash */
		0x0030, /* 0x30 0: 0 */
		0x0031, /* 0x31 1: 1 */
		0x0032, /* 0x32 2: 2 */
...
//		[0x11751173,0x1174], /* jungseong i  ㅣ + eu ㅡ = eui ㅢ */
	...
	K3_Semoe_combination_table = [
		...
		{phonemes: [0x1100,0x1100], char: 0x1101}, /* choseong gieug + gieug = ssang_gieug */
		{phonemes: [0x1100,0x1102], char: 0x1129}, /* choseong gieug + nieun = bieub-tieut */
		{phonemes: [0x1100,0x1103], char: 0x1117}, /* choseong gieug + dieud = dieud-gieug */
		{phonemes: [0x1100,0x1105], char: 0xA964}, /* choseong gieug + lieul = lieul-gieug */
		{phonemes: [0x1100,0x1107], char: 0x111E}, /* choseong gieug + bieub = bieub-gieug */
		{phonemes: [0x1100,0x1109], char: 0x112D}, /* choseong gieug + sieus = sieus-gieug */
		{phonemes: [0x1100,0x110B], char: 0x1101}, /* choseong gieug + ieung = ssang_gieug */
		{phonemes: [0x1100,0x110C], char: 0x1152}, /* choseong gieug + jieuj = chieuch-kieuk */
		{phonemes: [0x1100,0x1112], char: 0x110F}, /* choseong gieug + hieuh = kieuk */
		{phonemes: [0x1100,0x1121], char: 0x1122}, /* choseong gieug + bieub-sieus = bieub-sieus-gieug */
		{phonemes: [0x1100,0x1147], char: 0x1141}, /* choseong gieug + ssang_ieung = ieung-gieug */
		{phonemes: [0x1101,0x1100], char: 0x110F}, /* choseong ssang_gieug + gieug = kieuk */
		{phonemes: [0x1102,0x1100], char: 0x1129}, /* choseong nieun + gieug = bieub-tieut */
		{phonemes: [0x1102,0x1103], char: 0x1115}, /* choseong nieun + dieud = nieun-dieud */
		{phonemes: [0x1102,0x1105], char: 0x111B}, /* choseong nieun + lieul = gabyeounlieul */
		{phonemes: [0x1102,0x1106], char: 0x111D}, /* choseong nieun + mieum = gabyeounmieum */
		{phonemes: [0x1102,0x1107], char: 0x112B}, /* choseong nieun + bieub = gabyeounbieub */
		{phonemes: [0x1102,0x1108], char: 0x112C}, /* choseong nieun + ssang_bieub = gabyeounssang_bieub */
		{phonemes: [0x1102,0x1109], char: 0x112E}, /* choseong nieun + sieus = sieus-nieun */
		{phonemes: [0x1102,0x110B], char: 0x114C}, /* choseong nieun + ieung = yesieung */
		{phonemes: [0x1102,0x110C], char: 0x1157}, /* choseong nieun + jieuj = gabyeounpieup */
		{phonemes: [0x1102,0x1112], char: 0x1159}, /* choseong nieun + hieuh = yeolin_hieuh */
		{phonemes: [0x1102,0x1121], char: 0x114B}, /* choseong nieun + bieub-sieus = ieung-pieup */
		{phonemes: [0x1102,0x1140], char: 0xA976}, /* choseong nieun + bansieus = ieung-lieul */
		{phonemes: [0x1102,0x1147], char: 0x1114}, /* choseong nieun + ssang_ieung = ssang_nieun */
		{phonemes: [0x1103,0x1100], char: 0x1117}, /* choseong dieud + gieug = dieud-gieug */
		{phonemes: [0x1103,0x1102], char: 0x1115}, /* choseong dieud + nieun = nieun-dieud */
		{phonemes: [0x1103,0x1103], char: 0x1104}, /* choseong dieud + dieud = ssang_dieud */
		{phonemes: [0x1103,0x1105], char: 0x115E}, /* choseong dieud + lieul = dieud-lieul */
		{phonemes: [0x1103,0x1106], char: 0xA970}, /* choseong dieud + mieum = mieum-dieud */
		{phonemes: [0x1103,0x1107], char: 0x1120}, /* choseong dieud + bieub = bieub-dieud */
		{phonemes: [0x1103,0x1109], char: 0xA962}, /* choseong dieud + sieus = dieud-sieus */
		{phonemes: [0x1103,0x110B], char: 0x1104}, /* choseong dieud + ieung = ssang_dieud */
		{phonemes: [0x1103,0x110C], char: 0xA963}, /* choseong dieud + jieuj = dieud-jieuj */
		{phonemes: [0x1103,0x1112], char: 0x1110}, /* choseong dieud + hieuh = tieut */
		{phonemes: [0x1103,0x1121], char: 0x1123}, /* choseong dieud + bieub-sieus = bieub-sieus-dieud */
		{phonemes: [0x1103,0x1147], char: 0x1142}, /* choseong dieud + ssang_ieung = ieung-dieud */
		{phonemes: [0x1104,0x1103], char: 0x1110}, /* choseong ssang_dieud + dieud = tieut */
		{phonemes: [0x1105,0x1100], char: 0xA964}, /* choseong lieul + gieug = lieul-gieug */
		{phonemes: [0x1105,0x1102], char: 0x111B}, /* choseong lieul + nieun = gabyeounlieul */
		{phonemes: [0x1105,0x1103], char: 0x115E}, /* choseong lieul + dieud = dieud-lieul */
		{phonemes: [0x1105,0x1106], char: 0xA968}, /* choseong lieul + mieum = lieul-mieum */
		{phonemes: [0x1105,0x1107], char: 0xA969}, /* choseong lieul + bieub = lieul-bieub */
		{phonemes: [0x1105,0x1109], char: 0x112F}, /* choseong lieul + sieus = sieus-dieud */
		{phonemes: [0x1105,0x110B], char: 0xA976}, /* choseong lieul + ieung = ieung-lieul */
		{phonemes: [0x1105,0x110C], char: 0xA96D}, /* choseong lieul + jieuj = lieul-jieuj */
		{phonemes: [0x1105,0x1112], char: 0x111A}, /* choseong lieul + hieuh = lieul-hieuh */
		{phonemes: [0x1105,0x1147], char: 0x1119}, /* choseong lieul + ssang_ieung = ssang_lieul */
		{phonemes: [0x1106,0x1102], char: 0x111D}, /* choseong mieum + nieun = gabyeounmieum */
		{phonemes: [0x1106,0x1103], char: 0xA970}, /* choseong mieum + dieud = mieum-dieud */
		{phonemes: [0x1106,0x1105], char: 0xA968}, /* choseong mieum + lieul = lieul-mieum */
		{phonemes: [0x1106,0x1107], char: 0x111C}, /* choseong mieum + bieub = mieum-bieub */
		{phonemes: [0x1106,0x1109], char: 0x1131}, /* choseong mieum + sieus = sieus-mieum */
		{phonemes: [0x1106,0x110C], char: 0xA971}, /* choseong mieum + jieuj = mieum-sieus */
		{phonemes: [0x1106,0x1112], char: 0x1143}, /* choseong mieum + hieuh = ieung-mieum */
		{phonemes: [0x1107,0x1100], char: 0x111E}, /* choseong bieub + gieug = bieub-gieug */
		{phonemes: [0x1107,0x1102], char: 0x112B}, /* choseong bieub + nieun = gabyeounbieub */
		{phonemes: [0x1107,0x1103], char: 0x1120}, /* choseong bieub + dieud = bieub-dieud */
		{phonemes: [0x1107,0x1105], char: 0xA969}, /* choseong bieub + lieul = lieul-bieub */
		{phonemes: [0x1107,0x1106], char: 0x111C}, /* choseong bieub + mieum = mieum-bieub */
		{phonemes: [0x1107,0x1107], char: 0x1108}, /* choseong bieub + bieub = ssang_bieub */
		{phonemes: [0x1107,0x1109], char: 0x1121}, /* choseong bieub + sieus = bieub-sieus */
		{phonemes: [0x1107,0x110B], char: 0x1108}, /* choseong bieub + ieung = ssang_bieub */
		{phonemes: [0x1107,0x110C], char: 0x1127}, /* choseong bieub + jieuj = bieub-jieuj */
		{phonemes: [0x1107,0x1112], char: 0x1111}, /* choseong bieub + hieuh = pieup */
		{phonemes: [0x1107,0x1147], char: 0x1144}, /* choseong bieub + ssang_ieung = ieung-bieub */
		{phonemes: [0x1107,0x114C], char: 0x112C}, /* choseong bieub + yesieung = gabyeounssang_bieub */
		{phonemes: [0x1108,0x1102], char: 0x112C}, /* choseong ssang_bieub + nieun = gabyeounssang_bieub */
		{phonemes: [0x1108,0x1107], char: 0x1111}, /* choseong ssang_bieub + bieub = pieup */
		{phonemes: [0x1109,0x1100], char: 0x112D}, /* choseong sieus + gieug = sieus-gieug */
		{phonemes: [0x1109,0x1102], char: 0x112E}, /* choseong sieus + nieun = sieus-nieun */
		{phonemes: [0x1109,0x1103], char: 0xA962}, /* choseong sieus + dieud = dieud-sieus */
		{phonemes: [0x1109,0x1105], char: 0x112F}, /* choseong sieus + lieul = sieus-dieud */
		{phonemes: [0x1109,0x1106], char: 0x1131}, /* choseong sieus + mieum = sieus-mieum */
		{phonemes: [0x1109,0x1107], char: 0x1121}, /* choseong sieus + bieub = bieub-sieus */
		{phonemes: [0x1109,0x1109], char: 0x110A}, /* choseong sieus + sieus = ssang_sieus */
		{phonemes: [0x1109,0x110B], char: 0x110A}, /* choseong sieus + ieung = ssang_sieus */
		{phonemes: [0x1109,0x110C], char: 0x1136}, /* choseong sieus + jieuj = sieus-jieuj */
		{phonemes: [0x1109,0x1112], char: 0x1132}, /* choseong sieus + hieuh = sieus-bieub */
		{phonemes: [0x1109,0x1121], char: 0x113E}, /* choseong sieus + bieub-sieus = dwis_sieus */
		{phonemes: [0x1109,0x1140], char: 0x113C}, /* choseong sieus + bansieus = ap_sieus */
		{phonemes: [0x1109,0x1147], char: 0x1145}, /* choseong sieus + ssang_ieung = ieung-sieus */
		{phonemes: [0x1109,0x1154], char: 0x113D}, /* choseong sieus + ap_chieuch = ssang_ap_sieus */
		{phonemes: [0x1109,0x1155], char: 0x113F}, /* choseong sieus + dwis_chieuch = ssang_dwis_sieus */
		{phonemes: [0x110B,0x1100], char: 0x1101}, /* choseong ieung + gieug = ssang_gieug */
		{phonemes: [0x110B,0x1102], char: 0x114C}, /* choseong ieung + nieun = yesieung */
		{phonemes: [0x110B,0x1103], char: 0x1104}, /* choseong ieung + dieud = ssang_dieud */
		{phonemes: [0x110B,0x1105], char: 0xA976}, /* choseong ieung + lieul = ieung-lieul */
		...
		{phonemes: [0x110B,0x1112], char: 0x114A}, /* choseong ieung + hieuh = ieung-tieut */
		{phonemes: [0x110B,0x112B], char: 0x112C}, /* choseong ieung + gabyeounbieub = gabyeounssang_bieub */
		{phonemes: [0x110C,0x1100], char: 0x1152}, /* choseong jieuj + gieug = chieuch-kieuk */
		{phonemes: [0x110C,0x1102], char: 0x1157}, /* choseong jieuj + nieun = gabyeounpieup */
		{phonemes: [0x110C,0x1103], char: 0xA963}, /* choseong jieuj + dieud = dieud-jieuj */
		{phonemes: [0x110C,0x1105], char: 0xA96D}, /* choseong jieuj + lieul = lieul-jieuj */
		{phonemes: [0x110C,0x1106], char: 0xA971}, /* choseong jieuj + mieum = mieum-sieus */
		{phonemes: [0x110C,0x1107], char: 0x1127}, /* choseong jieuj + bieub = bieub-jieuj */
		{phonemes: [0x110C,0x1109], char: 0x1136}, /* choseong jieuj + sieus = sieus-jieuj */
		{phonemes: [0x110C,0x110B], char: 0x110D}, /* choseong jieuj + ieung = ssang_jieuj */
		{phonemes: [0x110C,0x110C], char: 0x110D}, /* choseong jieuj + jieuj = ssang_jieuj */
		{phonemes: [0x110C,0x1112], char: 0x110E}, /* choseong jieuj + hieuh = chieuch */
		{phonemes: [0x110C,0x1121], char: 0x1150}, /* choseong jieuj + bieub-sieus = dwis_jieuj */
		{phonemes: [0x110C,0x1140], char: 0x114E}, /* choseong jieuj + bansieus = ap_jieuj */
		{phonemes: [0x110C,0x1147], char: 0x110D}, /* choseong jieuj + ssang_ieung = ssang_jieuj */
		{phonemes: [0x110C,0x1154], char: 0x114F}, /* choseong jieuj + ap_chieuch = ssang_ap_jieuj */
		{phonemes: [0x110C,0x1155], char: 0x1151}, /* choseong jieuj + dwis_chieuch = ssang_dwis_jieuj */
		{phonemes: [0x110D,0x110C], char: 0x110E}, /* choseong ssang_jieuj + jieuj = chieuch */
		{phonemes: [0x110D,0x1121], char: 0x1151}, /* choseong ssang_jieuj + bieub-sieus = ssang_dwis_jieuj */
		{phonemes: [0x110D,0x1140], char: 0x114F}, /* choseong ssang_jieuj + bansieus = ssang_ap_jieuj */
		{phonemes: [0x1112,0x1100], char: 0x110F}, /* choseong hieuh + gieug = kieuk */
		{phonemes: [0x1112,0x1102], char: 0x1159}, /* choseong hieuh + nieun = yeolin_hieuh */
		{phonemes: [0x1112,0x1103], char: 0x1110}, /* choseong hieuh + dieud = tieut */
		{phonemes: [0x1112,0x1105], char: 0x111A}, /* choseong hieuh + lieul = lieul-hieuh */
		{phonemes: [0x1112,0x1106], char: 0x1143}, /* choseong hieuh + mieum = ieung-mieum */
		{phonemes: [0x1112,0x1107], char: 0x1111}, /* choseong hieuh + bieub = pieup */
		{phonemes: [0x1112,0x1109], char: 0x1132}, /* choseong hieuh + sieus = sieus-bieub */
		{phonemes: [0x1112,0x110B], char: 0x114A}, /* choseong hieuh + ieung = ieung-tieut */
		{phonemes: [0x1112,0x110C], char: 0x110E}, /* choseong hieuh + jieuj = chieuch */
		{phonemes: [0x1112,0x1147], char: 0x1158}, /* choseong hieuh + ssang_ieung = ssang_hieuh */
		{phonemes: [0x1121,0x1100], char: 0x1122}, /* choseong bieub-sieus + gieug = bieub-sieus-gieug */
		{phonemes: [0x1121,0x1102], char: 0x114B}, /* choseong bieub-sieus + nieun = ieung-pieup */
		{phonemes: [0x1121,0x1103], char: 0x1123}, /* choseong bieub-sieus + dieud = bieub-sieus-dieud */
		{phonemes: [0x1121,0x1109], char: 0x113E}, /* choseong bieub-sieus + sieus = dwis_sieus */
		{phonemes: [0x1121,0x110C], char: 0x1150}, /* choseong bieub-sieus + jieuj = dwis_jieuj */
		{phonemes: [0x1121,0x110D], char: 0x1151}, /* choseong bieub-sieus + ssang_jieuj = ssang_dwis_jieuj */
		{phonemes: [0x1121,0x1145], char: 0x113F}, /* choseong bieub-sieus + ieung-sieus = ssang_dwis_sieus */
		{phonemes: [0x1121,0x1147], char: 0x1155}, /* choseong bieub-sieus + ssang_ieung = dwis_chieuch */
		{phonemes: [0x112B,0x110B], char: 0x112C}, /* choseong gabyeounbieub + ieung = gabyeounssang_bieub */
		{phonemes: [0x113C,0x1147], char: 0x113D}, /* choseong ap_sieus + ssang_ieung = ssang_ap_sieus */
		{phonemes: [0x113E,0x1147], char: 0x113F}, /* choseong dwis_sieus + ssang_ieung = ssang_dwis_sieus */
		{phonemes: [0x1140,0x1102], char: 0xA976}, /* choseong bansieus + nieun = ieung-lieul */
		{phonemes: [0x1140,0x1109], char: 0x113C}, /* choseong bansieus + sieus = ap_sieus */
		{phonemes: [0x1140,0x110C], char: 0x114E}, /* choseong bansieus + jieuj = ap_jieuj */
		{phonemes: [0x1140,0x110D], char: 0x114F}, /* choseong bansieus + ssang_jieuj = ssang_ap_jieuj */
		{phonemes: [0x1140,0x1145], char: 0x113D}, /* choseong bansieus + ieung-sieus = ssang_ap_sieus */
		{phonemes: [0x1140,0x1147], char: 0x1154}, /* choseong bansieus + ssang_ieung = ap_chieuch */
		{phonemes: [0x1145,0x1121], char: 0x113F}, /* choseong ieung-sieus + bieub-sieus = ssang_dwis_sieus */
		{phonemes: [0x1145,0x1140], char: 0x113D}, /* choseong ieung-sieus + bansieus = ssang_ap_sieus */
		{phonemes: [0x1147,0x1100], char: 0x1141}, /* choseong ssang_ieung + gieug = ieung-gieug */
		{phonemes: [0x1147,0x1102], char: 0x1114}, /* choseong ssang_ieung + nieun = ssang_nieun */
		{phonemes: [0x1147,0x1103], char: 0x1142}, /* choseong ssang_ieung + dieud = ieung-dieud */
		{phonemes: [0x1147,0x1105], char: 0x1119}, /* choseong ssang_ieung + lieul = ssang_lieul */
		{phonemes: [0x1147,0x1107], char: 0x1144}, /* choseong ssang_ieung + bieub = ieung-bieub */
		{phonemes: [0x1147,0x1109], char: 0x1145}, /* choseong ssang_ieung + sieus = ieung-sieus */
		{phonemes: [0x1147,0x110C], char: 0x110D}, /* choseong ssang_ieung + jieuj = ssang_jieuj */
		{phonemes: [0x1147,0x1112], char: 0x1158}, /* choseong ssang_ieung + hieuh = ssang_hieuh */
		{phonemes: [0x1147,0x1121], char: 0x1155}, /* choseong ssang_ieung + bieub-sieus = dwis_chieuch */
		{phonemes: [0x1147,0x113C], char: 0x113D}, /* choseong ssang_ieung + ap_sieus = ssang_ap_sieus */
		{phonemes: [0x1147,0x113E], char: 0x113F}, /* choseong ssang_ieung + dwis_sieus = ssang_dwis_sieus */
		{phonemes: [0x1147,0x1140], char: 0x1154}, /* choseong ssang_ieung + bansieus = ap_chieuch */
		{phonemes: [0x1147,0x114E], char: 0x114F}, /* choseong ssang_ieung + ap_jieuj = ssang_ap_jieuj */
		{phonemes: [0x1147,0x1150], char: 0x1151}, /* choseong ssang_ieung + dwis_jieuj = ssang_dwis_jieuj */
		{phonemes: [0x114C,0x1107], char: 0x112C}, /* choseong yesieung + bieub = gabyeounssang_bieub */
		{phonemes: [0x114E,0x1147], char: 0x114F}, /* choseong ap_jieuj + ssang_ieung = ssang_ap_jieuj */
		{phonemes: [0x1150,0x1147], char: 0x1151}, /* choseong dwis_jieuj + ssang_ieung = ssang_dwis_jieuj */
		{phonemes: [0x1154,0x1109], char: 0x113D}, /* choseong ap_chieuch + sieus = ssang_ap_sieus */
		{phonemes: [0x1154,0x110C], char: 0x114F}, /* choseong ap_chieuch + jieuj = ssang_ap_jieuj */
		{phonemes: [0x1155,0x1109], char: 0x113F}, /* choseong dwis_chieuch + sieus = ssang_dwis_sieus */
		{phonemes: [0x1155,0x110C], char: 0x1151}, /* choseong dwis_chieuch + jieuj = ssang_dwis_jieuj */
		{phonemes: [0x1161,0x1161], char: 0x1163}, /* jungseong a + a = ya */
		{phonemes: [0x1161,0x1165], char: 0x116D}, /* jungseong a + eo = yo */
		{phonemes: [0x1161,0x1166], char: 0x1198}, /* jungseong a + e = i-a */
		{phonemes: [0x1161,0x1169], char: 0x116A}, /* jungseong a + o = wa */
		{phonemes: [0x1161,0x116C], char: 0x116B}, /* jungseong a + oe = wae */
		{phonemes: [0x1161,0x116E], char: 0x1189}, /* jungseong a + u = u-a */
		{phonemes: [0x1161,0x1173], char: 0x119E}, /* jungseong a + eu = alae_a */
		{phonemes: [0x1161,0x1174], char: 0x11A1}, /* jungseong a + eui = alae_a-i */
		{phonemes: [0x1161,0x1175], char: 0x1162}, /* jungseong a + i = ae */
		{phonemes: [0x1161,0x1188], char: 0x1176}, /* jungseong a + yo-i = a-o */
		{phonemes: [0x1161,0x1194], char: 0x1177}, /* jungseong a + yu-i = a-u */
		{phonemes: [0x1161,0x011169], char: 0x116A}, /* jungseong a + o = wa */
		{phonemes: [0x1162,0x1169], char: 0x116B}, /* jungseong ae + o = wae */
		{phonemes: [0x1162,0x1173], char: 0x11A1}, /* jungseong ae + eu = alae_a-i */
		{phonemes: [0x1162,0x011169], char: 0x116B}, /* jungseong ae + o = wae */
		{phonemes: [0x1163,0x1173], char: 0x11A2}, /* jungseong ya + eu = ssang_alae_a */
		{phonemes: [0x1165,0x1161], char: 0x116D}, /* jungseong eo + a = yo */
		{phonemes: [0x1165,0x1165], char: 0x116F}, /* jungseong eo + eo = weo */
		{phonemes: [0x1165,0x1166], char: 0xD7BF}, /* jungseong eo + e = i-yeo */
		{phonemes: [0x1165,0x1167], char: 0xD7C4}, /* jungseong eo + yeo = i-i */
		{phonemes: [0x1165,0x1169], char: 0x116F}, /* jungseong eo + o = weo */
		{phonemes: [0x1165,0x116E], char: 0x116F}, /* jungseong eo + u = weo */
		{phonemes: [0x1165,0x1171], char: 0x1170}, /* jungseong eo + wi = we */
		{phonemes: [0x1165,0x1173], char: 0x11A2}, /* jungseong eo + eu = ssang_alae_a */
		{phonemes: [0x1165,0x1188], char: 0x1184}, /* jungseong eo + yo-i = yo-ya */
		{phonemes: [0x1165,0x11A1], char: 0x117A}, /* jungseong eo + alae_a-i = eo-o */
		{phonemes: [0x1165,0x011169], char: 0x116F}, /* jungseong eo + o = weo */
		{phonemes: [0x1166,0x1161], char: 0x1198}, /* jungseong e + a = i-a */
		{phonemes: [0x1166,0x1165], char: 0xD7BF}, /* jungseong e + eo = i-yeo */
		{phonemes: [0x1166,0x1166], char: 0x1168}, /* jungseong e + e = ye */
		{phonemes: [0x1166,0x1167], char: 0xD7BE}, /* jungseong e + yeo = i-yae */
		{phonemes: [0x1166,0x1169], char: 0x1168}, /* jungseong e + o = ye */
		{phonemes: [0x1166,0x116E], char: 0x1170}, /* jungseong e + u = we */
		{phonemes: [0x1166,0x1173], char: 0xD7BB}, /* jungseong e + eu = eu-e */
		{phonemes: [0x1166,0x1175], char: 0x1171}, /* jungseong e + i = wi */
		{phonemes: [0x1166,0x1188], char: 0x1180}, /* jungseong e + yo-i = o-e */
		{phonemes: [0x1166,0x1194], char: 0x1192}, /* jungseong e + yu-i = yu-ye */
		{phonemes: [0x1166,0x011169], char: 0x1168}, /* jungseong e + o = ye */
		{phonemes: [0x1167,0x1165], char: 0xD7C4}, /* jungseong yeo + eo = i-i */
		{phonemes: [0x1167,0x1166], char: 0xD7BE}, /* jungseong yeo + e = i-yae */
		{phonemes: [0x1167,0x1167], char: 0x1164}, /* jungseong yeo + yeo = yae */
		{phonemes: [0x1167,0x1169], char: 0x1164}, /* jungseong yeo + o = yae */
		{phonemes: [0x1167,0x116E], char: 0x117E}, /* jungseong yeo + u = yeo-u */
		{phonemes: [0x1167,0x1173], char: 0xD7B0}, /* jungseong yeo + eu = o-yeo */
		{phonemes: [0x1167,0x1188], char: 0x1185}, /* jungseong yeo + yo-i = yo-yae */
		{phonemes: [0x1167,0x1194], char: 0x1191}, /* jungseong yeo + yu-i = yu-yeo */
		{phonemes: [0x1167,0x11A1], char: 0x117D}, /* jungseong yeo + alae_a-i = yeo-o */
		{phonemes: [0x1167,0x011169], char: 0x1164}, /* jungseong yeo + o = yae */
		{phonemes: [0x1168,0x1175], char: 0xD7C0}, /* jungseong ye + i = i-ye */
		{phonemes: [0x1169,0x1161], char: 0x116A}, /* jungseong o + a = wa */
		{phonemes: [0x1169,0x1162], char: 0x116B}, /* jungseong o + ae = wae */
		{phonemes: [0x1169,0x1165], char: 0x116F}, /* jungseong o + eo = weo */
		...
		{phonemes: [0x1169,0x1173], char: 0xD7BC}, /* jungseong o + eu = eu-o */
		{phonemes: [0x1169,0x1175], char: 0x116C}, /* jungseong o + i = oe */
		{phonemes: [0x1169,0x11A1], char: 0x1178}, /* jungseong o + alae_a-i = ya-o */
		{phonemes: [0x1169,0x011169], char: 0x116D}, /* jungseong o + o = yo */
		{phonemes: [0x116A,0x1175], char: 0x116B}, /* jungseong wa + i = wae */
		{phonemes: [0x116C,0x1161], char: 0x116B}, /* jungseong oe + a = wae */
		{phonemes: [0x116C,0x1166], char: 0xD7C0}, /* jungseong oe + e = i-ye */
		{phonemes: [0x116C,0x116E], char: 0xD7C0}, /* jungseong oe + u = i-ye */
		{phonemes: [0x116E,0x1161], char: 0x1189}, /* jungseong u + a = u-a */
		{phonemes: [0x116E,0x1165], char: 0x116F}, /* jungseong u + eo = weo */
		{phonemes: [0x116E,0x1166], char: 0x1170}, /* jungseong u + e = we */
		{phonemes: [0x116E,0x1167], char: 0x117E}, /* jungseong u + yeo = yeo-u */
		{phonemes: [0x116E,0x1169], char: 0x1172}, /* jungseong u + o = yu */
		{phonemes: [0x116E,0x116E], char: 0x1172}, /* jungseong u + u = yu */
		{phonemes: [0x116E,0x1173], char: 0x1195}, /* jungseong u + eu = eu-u */
		{phonemes: [0x116E,0x1175], char: 0x1171}, /* jungseong u + i = wi */
		{phonemes: [0x116E,0x011169], char: 0x1172}, /* jungseong u + o = yu */
		{phonemes: [0x116F,0x1175], char: 0x1170}, /* jungseong weo + i = we */
		{phonemes: [0x1171,0x1165], char: 0x1170}, /* jungseong wi + eo = we */
		{phonemes: [0x1171,0x1166], char: 0xD7C0}, /* jungseong wi + e = i-ye */
		{phonemes: [0x1171,0x1169], char: 0xD7C0}, /* jungseong wi + o = i-ye */
		{phonemes: [0x1171,0x011169], char: 0xD7C0}, /* jungseong wi + o = i-ye */
		{phonemes: [0x1171,0x116E], char: 0xD7C0}, /* jungseong wi + u = i-ye */
		{phonemes: [0x1172,0x1175], char: 0xD7C0}, /* jungseong yu + i = i-ye */
		{phonemes: [0x1173,0x1161], char: 0x119E}, /* jungseong eu + a = alae_a */
		{phonemes: [0x1173,0x1162], char: 0x11A1}, /* jungseong eu + ae = alae_a-i */
		{phonemes: [0x1173,0x1163], char: 0x11A2}, /* jungseong eu + ya = ssang_alae_a */
		{phonemes: [0x1173,0x1165], char: 0x11A2}, /* jungseong eu + eo = ssang_alae_a */
		{phonemes: [0x1173,0x1166], char: 0xD7BB}, /* jungseong eu + e = eu-e */
		{phonemes: [0x1173,0x1167], char: 0xD7B0}, /* jungseong eu + yeo = o-yeo */
		{phonemes: [0x1173,0x1169], char: 0xD7BC}, /* jungseong eu + o = eu-o */
		{phonemes: [0x1173,0x116E], char: 0x1195}, /* jungseong eu + u = eu-u */
		{phonemes: [0x1173,0x1173], char: 0x1163}, /* jungseong eu + eu = ya */
		{phonemes: [0x1173,0x1175], char: 0x1174}, /* jungseong eu + i = eui */
		{phonemes: [0x1173,0x11A1], char: 0xD7BA}, /* jungseong eu + alae_a-i = eu-eo */
		{phonemes: [0x1173,0x011169], char: 0x1163}, /* jungseong eu + o = ya */
		{phonemes: [0x1174,0x1161], char: 0x11A1}, /* jungseong eui + a = alae_a-i */
		{phonemes: [0x1175,0x1161], char: 0x1162}, /* jungseong i + a = ae */
		{phonemes: [0x1175,0x1166], char: 0x1171}, /* jungseong i + e = wi */
		{phonemes: [0x1175,0x1168], char: 0xD7C0}, /* jungseong i + ye = i-ye */
		{phonemes: [0x1175,0x1169], char: 0x116C}, /* jungseong i + o = oe */
		{phonemes: [0x1175,0x116A], char: 0x116B}, /* jungseong i + wa = wae */
		{phonemes: [0x1175,0x116E], char: 0x1171}, /* jungseong i + u = wi */
		{phonemes: [0x1175,0x116F], char: 0x1170}, /* jungseong i + weo = we */
		{phonemes: [0x1175,0x1172], char: 0xD7C0}, /* jungseong i + yu = i-ye */
		{phonemes: [0x1175,0x1173], char: 0x1174}, /* jungseong i + eu = eui */
		{phonemes: [0x1175,0x119E], char: 0x11A1}, /* jungseong i + alae_a = alae_a-i */
		{phonemes: [0x1175,0x11A1], char: 0x119C}, /* jungseong i + alae_a-i = i-eu */
		{phonemes: [0x1175,0x011169], char: 0x116C}, /* jungseong i + o = oe */
		{phonemes: [0x1188,0x1161], char: 0x1176}, /* jungseong yo-i + a = a-o */
		{phonemes: [0x1188,0x1165], char: 0x1184}, /* jungseong yo-i + eo = yo-ya */
		{phonemes: [0x1188,0x1166], char: 0x1180}, /* jungseong yo-i + e = o-e */
		{phonemes: [0x1188,0x1167], char: 0x1185}, /* jungseong yo-i + yeo = yo-yae */
		{phonemes: [0x1194,0x1161], char: 0x1177}, /* jungseong yu-i + a = a-u */
		{phonemes: [0x1194,0x1166], char: 0x1192}, /* jungseong yu-i + e = yu-ye */
		{phonemes: [0x1194,0x1167], char: 0x1191}, /* jungseong yu-i + yeo = yu-yeo */
		{phonemes: [0x119E,0x1175], char: 0x11A1}, /* jungseong alae_a + i = alae_a-i */
		{phonemes: [0x119E,0x119E], char: 0x11A2}, /* jungseong alae_a + alae_a = ssang_alae_a */
		{phonemes: [0x11A1,0x1165], char: 0x117A}, /* jungseong alae_a-i + eo = eo-o */
		{phonemes: [0x11A1,0x1167], char: 0x117D}, /* jungseong alae_a-i + yeo = yeo-o */
		{phonemes: [0x11A1,0x1169], char: 0x1178}, /* jungseong alae_a-i + o = ya-o */
		{phonemes: [0x11A1,0x1173], char: 0xD7BA}, /* jungseong alae_a-i + eu = eu-eo */
		{phonemes: [0x11A1,0x1175], char: 0x119C}, /* jungseong alae_a-i + i = i-eu */
		{phonemes: [0x11A1,0x011169], char: 0x1178}, /* jungseong alae_a-i + o = ya-o */
		{phonemes: [0x011169,0x1161], char: 0x116A}, /* jungseong o + a = wa */
		{phonemes: [0x011169,0x1162], char: 0x116B}, /* jungseong o + ae = wae */
		{phonemes: [0x011169,0x1165], char: 0x116F}, /* jungseong o + eo = weo */
		{phonemes: [0x011169,0x1166], char: 0x1168}, /* jungseong o + e = ye */
		{phonemes: [0x011169,0x1167], char: 0x1164}, /* jungseong o + yeo = yae */
		{phonemes: [0x011169,0x1169], char: 0x116D}, /* jungseong o + o = yo */
		{phonemes: [0x011169,0x116E], char: 0x1172}, /* jungseong o + u = yu */
		{phonemes: [0x011169,0x1173], char: 0x1163}, /* jungseong o + eu = ya */
		{phonemes: [0x011169,0x1175], char: 0x116C}, /* jungseong o + i = oe */
		{phonemes: [0x011169,0x11A1], char: 0x1178}, /* jungseong o + alae_a-i = ya-o */
		{phonemes: [0x011169,0x011169], char: 0x116D}, /* jungseong o + o = yo */
		{phonemes: [0x11A8,0x11A8], char: 0x11A9}, /* jongseong gieug + gieug = ssang_gieug */
		{phonemes: [0x11A8,0x11AB], char: 0x11FA}, /* jongseong gieug + nieun = gieug-nieun */
		{phonemes: [0x11A8,0x11AE], char: 0x11AA}, /* jongseong gieug + dieud = gieug-sieus */
		{phonemes: [0x11A8,0x11AF], char: 0x11B0}, /* jongseong gieug + lieul = lieul-gieug */
		{phonemes: [0x11A8,0x11B3], char: 0x11CC}, /* jongseong gieug + lieul-sieus = lieul-gieug-sieus */
		{phonemes: [0x11A8,0x11B7], char: 0x11B0}, /* jongseong gieug + mieum = lieul-gieug */
		{phonemes: [0x11A8,0x11B8], char: 0x11FB}, /* jongseong gieug + bieub = gieug-bieub */
		{phonemes: [0x11A8,0x11BA], char: 0x11AA}, /* jongseong gieug + sieus = gieug-sieus */
		{phonemes: [0x11A8,0x11BB], char: 0x11BF}, /* jongseong gieug + ssang_sieus = kieuk */
		{phonemes: [0x11A8,0x11BC], char: 0x11A9}, /* jongseong gieug + ieung = ssang_gieug */
		{phonemes: [0x11A8,0x11C2], char: 0x11BF}, /* jongseong gieug + hieuh = kieuk */
		{phonemes: [0x11A8,0x11D9], char: 0x11E7}, /* jongseong gieug + lieul-yeolin_hieuh = sieus-gieug */
		{phonemes: [0x11A9,0x11A8], char: 0x11BF}, /* jongseong ssang_gieug + gieug = kieuk */
		{phonemes: [0x11AB,0x11A8], char: 0x11FA}, /* jongseong nieun + gieug = gieug-nieun */
		{phonemes: [0x11AB,0x11AB], char: 0x11C2}, /* jongseong nieun + nieun = hieuh */
		...
		{phonemes: [0x11AB,0x11B8], char: 0x11C1}, /* jongseong nieun + bieub = pieup */
		{phonemes: [0x11AB,0x11BA], char: 0x11C7}, /* jongseong nieun + sieus = nieun-sieus */
		{phonemes: [0x11AB,0x11BB], char: 0x11C2}, /* jongseong nieun + ssang_sieus = hieuh */
		{phonemes: [0x11AB,0x11BC], char: 0x11AD}, /* jongseong nieun + ieung = nieun-hieuh */
		{phonemes: [0x11AB,0x11BD], char: 0x11AC}, /* jongseong nieun + jieuj = nieun-jieuj */
		{phonemes: [0x11AB,0x11C2], char: 0x11AD}, /* jongseong nieun + hieuh = nieun-hieuh */
		{phonemes: [0x11AB,0x11D9], char: 0x11C6}, /* jongseong nieun + lieul-yeolin_hieuh = nieun-dieud */
		{phonemes: [0x11AB,0x11EB], char: 0x11C8}, /* jongseong nieun + bansieus = nieun-bansieus */
		{phonemes: [0x11AC,0x11AB], char: 0x11B6}, /* jongseong nieun-jieuj + nieun = lieul-hieuh */
		{phonemes: [0x11AE,0x11A8], char: 0x11AA}, /* jongseong dieud + gieug = gieug-sieus */
		{phonemes: [0x11AE,0x11B6], char: 0x11B4}, /* jongseong dieud + lieul-hieuh = lieul-tieut */
		{phonemes: [0x11AE,0x11B7], char: 0x11C0}, /* jongseong dieud + mieum = tieut */
		{phonemes: [0x11AE,0x11BC], char: 0x11B4}, /* jongseong dieud + ieung = lieul-tieut */
		{phonemes: [0x11AE,0x11C2], char: 0x11C0}, /* jongseong dieud + hieuh = tieut */
		{phonemes: [0x11AF,0x11A8], char: 0x11B0}, /* jongseong lieul + gieug = lieul-gieug */
		{phonemes: [0x11AF,0x11AB], char: 0x11AC}, /* jongseong lieul + nieun = nieun-jieuj */
		{phonemes: [0x11AF,0x11AF], char: 0x11BD}, /* jongseong lieul + lieul = jieuj */
		{phonemes: [0x11AF,0x11B7], char: 0x11B1}, /* jongseong lieul + mieum = lieul-mieum */
		{phonemes: [0x11AF,0x11B8], char: 0x11B2}, /* jongseong lieul + bieub = lieul-bieub */
		{phonemes: [0x11AF,0x11BA], char: 0x11B3}, /* jongseong lieul + sieus = lieul-sieus */
		{phonemes: [0x11AF,0x11BB], char: 0x11BD}, /* jongseong lieul + ssang_sieus = jieuj */
		{phonemes: [0x11AF,0x11BC], char: 0x11A8}, /* jongseong lieul + ieung = gieug */
		{phonemes: [0x11AF,0x11BE], char: 0x11A9}, /* jongseong lieul + chieuch = ssang_gieug */
		{phonemes: [0x11AF,0x11C0], char: 0x11B4}, /* jongseong lieul + tieut = lieul-tieut */
		{phonemes: [0x11AF,0x11C1], char: 0x11B5}, /* jongseong lieul + pieup = lieul-pieup */
		{phonemes: [0x11AF,0x11C2], char: 0x11B6}, /* jongseong lieul + hieuh = lieul-hieuh */
		{phonemes: [0x11AF,0x11D9], char: 0x11CE}, /* jongseong lieul + lieul-yeolin_hieuh = lieul-dieud */
		{phonemes: [0x11AF,0x11EB], char: 0x11D7}, /* jongseong lieul + bansieus = lieul-bansieus */
		{phonemes: [0x11B0,0x11BB], char: 0x11AA}, /* jongseong lieul-gieug + ssang_sieus = gieug-sieus */
		{phonemes: [0x11B1,0x11B7], char: 0x11B4}, /* jongseong lieul-mieum + mieum = lieul-tieut */
		{phonemes: [0x11B2,0x11B8], char: 0x11B5}, /* jongseong lieul-bieub + bieub = lieul-pieup */
		{phonemes: [0x11B2,0x11BB], char: 0x11C0}, /* jongseong lieul-bieub + ssang_sieus = tieut */
		{phonemes: [0x11B3,0x11A8], char: 0x11CC}, /* jongseong lieul-sieus + gieug = lieul-gieug-sieus */
		{phonemes: [0x11B3,0x11B8], char: 0x11D3}, /* jongseong lieul-sieus + bieub = lieul-bieub-sieus */
		{phonemes: [0x11B3,0x11BA], char: 0x11BD}, /* jongseong lieul-sieus + sieus = jieuj */
		{phonemes: [0x11B3,0x11BB], char: 0x11A9}, /* jongseong lieul-sieus + ssang_sieus = ssang_gieug */
		{phonemes: [0x11B3,0x11D9], char: 0x11EA}, /* jongseong lieul-sieus + lieul-yeolin_hieuh = sieus-bieub */
		{phonemes: [0x11B6,0x11AE], char: 0x11B4}, /* jongseong lieul-hieuh + dieud = lieul-tieut */
		{phonemes: [0x11B6,0x11AF], char: 0x11BF}, /* jongseong lieul-hieuh + lieul = kieuk */
		{phonemes: [0x11B6,0x11B8], char: 0x11B5}, /* jongseong lieul-hieuh + bieub = lieul-pieup */
		{phonemes: [0x11B7,0x11A8], char: 0x11B0}, /* jongseong mieum + gieug = lieul-gieug */
		{phonemes: [0x11B7,0x11AB], char: 0x11C0}, /* jongseong mieum + nieun = tieut */
		{phonemes: [0x11B7,0x11AF], char: 0x11B1}, /* jongseong mieum + lieul = lieul-mieum */
		{phonemes: [0x11B7,0x11B7], char: 0x11AE}, /* jongseong mieum + mieum = dieud */
		{phonemes: [0x11B7,0x11B8], char: 0x11DC}, /* jongseong mieum + bieub = mieum-bieub */
		{phonemes: [0x11B7,0x11BA], char: 0x11DD}, /* jongseong mieum + sieus = mieum-sieus */
		{phonemes: [0x11B7,0x11BB], char: 0x11AE}, /* jongseong mieum + ssang_sieus = dieud */
		{phonemes: [0x11B7,0x11BC], char: 0x11B4}, /* jongseong mieum + ieung = lieul-tieut */
		{phonemes: [0x11B7,0x11BF], char: 0x11AA}, /* jongseong mieum + kieuk = gieug-sieus */
		{phonemes: [0x11B7,0x11D9], char: 0x11E2}, /* jongseong mieum + lieul-yeolin_hieuh = gabyeounmieum */
		{phonemes: [0x11B7,0x11EB], char: 0x11DF}, /* jongseong mieum + bansieus = mieum-bansieus */
		{phonemes: [0x11B8,0x11A8], char: 0x11FB}, /* jongseong bieub + gieug = gieug-bieub */
		{phonemes: [0x11B8,0x11AB], char: 0x11C1}, /* jongseong bieub + nieun = pieup */
		{phonemes: [0x11B8,0x11AF], char: 0x11B2}, /* jongseong bieub + lieul = lieul-bieub */
		{phonemes: [0x11B8,0x11B3], char: 0x11D3}, /* jongseong bieub + lieul-sieus = lieul-bieub-sieus */
		{phonemes: [0x11B8,0x11B6], char: 0x11B5}, /* jongseong bieub + lieul-hieuh = lieul-pieup */
		{phonemes: [0x11B8,0x11B7], char: 0x11DC}, /* jongseong bieub + mieum = mieum-bieub */
		{phonemes: [0x11B8,0x11B8], char: 0x11C1}, /* jongseong bieub + bieub = pieup */
		{phonemes: [0x11B8,0x11BA], char: 0x11B9}, /* jongseong bieub + sieus = bieub-sieus */
		{phonemes: [0x11B8,0x11BB], char: 0x11C1}, /* jongseong bieub + ssang_sieus = pieup */
		{phonemes: [0x11B8,0x11BC], char: 0x11B5}, /* jongseong bieub + ieung = lieul-pieup */
		{phonemes: [0x11B8,0x11BD], char: 0x11C0}, /* jongseong bieub + jieuj = tieut */
		{phonemes: [0x11B8,0x11BE], char: 0x11B1}, /* jongseong bieub + chieuch = lieul-mieum */
		{phonemes: [0x11B8,0x11C2], char: 0x11C1}, /* jongseong bieub + hieuh = pieup */
		{phonemes: [0x11B8,0x11D9], char: 0x11E6}, /* jongseong bieub + lieul-yeolin_hieuh = gabyeounbieub */
		{phonemes: [0x11B9,0x11BB], char: 0x11B1}, /* jongseong bieub-sieus + ssang_sieus = lieul-mieum */
		{phonemes: [0x11BA,0x11A8], char: 0x11AA}, /* jongseong sieus + gieug = gieug-sieus */
		{phonemes: [0x11BA,0x11AB], char: 0x11C7}, /* jongseong sieus + nieun = nieun-sieus */
		{phonemes: [0x11BA,0x11AF], char: 0x11B3}, /* jongseong sieus + lieul = lieul-sieus */
		{phonemes: [0x11BA,0x11B7], char: 0x11DD}, /* jongseong sieus + mieum = mieum-sieus */
		{phonemes: [0x11BA,0x11B8], char: 0x11B9}, /* jongseong sieus + bieub = bieub-sieus */
		{phonemes: [0x11BA,0x11BA], char: 0x11BB}, /* jongseong sieus + sieus = ssang_sieus */
		...
		{phonemes: [0x11BA,0x11BD], char: 0x11A9}, /* jongseong sieus + jieuj = ssang_gieug */
		{phonemes: [0x11BA,0x11C1], char: 0x11B1}, /* jongseong sieus + pieup = lieul-mieum */
		{phonemes: [0x11BA,0x11D9], char: 0x11E8}, /* jongseong sieus + lieul-yeolin_hieuh = sieus-dieud */
		{phonemes: [0x11BA,0x11F0], char: 0x11F1}, /* jongseong sieus + yesieung = yesieung-sieus */
		...
		{phonemes: [0x11BB,0x11AE], char: 0x11C0}, /* jongseong ssang_sieus + dieud = tieut */
		{phonemes: [0x11BB,0x11AF], char: 0x11BD}, /* jongseong ssang_sieus + lieul = jieuj */
		{phonemes: [0x11BB,0x11B0], char: 0x11AA}, /* jongseong ssang_sieus + lieul-gieug = gieug-sieus */
		{phonemes: [0x11BB,0x11B2], char: 0x11C0}, /* jongseong ssang_sieus + lieul-bieub = tieut */
		{phonemes: [0x11BB,0x11B3], char: 0x11A9}, /* jongseong ssang_sieus + lieul-sieus = ssang_gieug */
		...
		{phonemes: [0x11BB,0x11B9], char: 0x11B1}, /* jongseong ssang_sieus + bieub-sieus = lieul-mieum */
		...
		{phonemes: [0x11BC,0x11A8], char: 0x11A9}, /* jongseong ieung + gieug = ssang_gieug */
		{phonemes: [0x11BC,0x11AB], char: 0x11AD}, /* jongseong ieung + nieun = nieun-hieuh */
		{phonemes: [0x11BC,0x11AF], char: 0x11A8}, /* jongseong ieung + lieul = gieug */
		{phonemes: [0x11BC,0x11B7], char: 0x11B4}, /* jongseong ieung + mieum = lieul-tieut */
		...
		{phonemes: [0x11BC,0x11BC], char: 0x11C0}, /* jongseong ieung + ieung = tieut */
		{phonemes: [0x11BC,0x11D9], char: 0x11F4}, /* jongseong ieung + lieul-yeolin_hieuh = gabyeounpieup */
		{phonemes: [0x11BD,0x11B8], char: 0x11C0}, /* jongseong jieuj + bieub = tieut */
		{phonemes: [0x11BD,0x11BA], char: 0x11A9}, /* jongseong jieuj + sieus = ssang_gieug */
		{phonemes: [0x11BD,0x11BC], char: 0x11BF}, /* jongseong jieuj + ieung = kieuk */
		{phonemes: [0x11BE,0x11AF], char: 0x11A9}, /* jongseong chieuch + lieul = ssang_gieug */
		{phonemes: [0x11BE,0x11B8], char: 0x11B1}, /* jongseong chieuch + bieub = lieul-mieum */
		{phonemes: [0x11BF,0x11B7], char: 0x11AA}, /* jongseong kieuk + mieum = gieug-sieus */
		{phonemes: [0x11C0,0x11BC], char: 0x11B6}, /* jongseong tieut + ieung = lieul-hieuh */
		{phonemes: [0x11C1,0x11AF], char: 0x11C0}, /* jongseong pieup + lieul = tieut */
		{phonemes: [0x11C1,0x11BA], char: 0x11B1}, /* jongseong pieup + sieus = lieul-mieum */
		{phonemes: [0x11C2,0x11A8], char: 0x11BF}, /* jongseong hieuh + gieug = kieuk */
		{phonemes: [0x11C2,0x11AB], char: 0x11AD}, /* jongseong hieuh + nieun = nieun-hieuh */
		...
		{phonemes: [0x11D9,0x11A8], char: 0x11E7}, /* jongseong lieul-yeolin_hieuh + gieug = sieus-gieug */
		{phonemes: [0x11D9,0x11AB], char: 0x11C6}, /* jongseong lieul-yeolin_hieuh + nieun = nieun-dieud */
		{phonemes: [0x11D9,0x11AF], char: 0x11CE}, /* jongseong lieul-yeolin_hieuh + lieul = lieul-dieud */
		{phonemes: [0x11D9,0x11B3], char: 0x11EA}, /* jongseong lieul-yeolin_hieuh + lieul-sieus = sieus-bieub */
		{phonemes: [0x11D9,0x11B7], char: 0x11E2}, /* jongseong lieul-yeolin_hieuh + mieum = gabyeounmieum */
		{phonemes: [0x11D9,0x11B8], char: 0x11E6}, /* jongseong lieul-yeolin_hieuh + bieub = gabyeounbieub */
		{phonemes: [0x11D9,0x11BA], char: 0x11E8}, /* jongseong lieul-yeolin_hieuh + sieus = sieus-dieud */
		{phonemes: [0x11D9,0x11BC], char: 0x11F4}, /* jongseong lieul-yeolin_hieuh + ieung = gabyeounpieup */
		{phonemes: [0x11D9,0x11EB], char: 0xD7D7}, /* jongseong lieul-yeolin_hieuh + bansieus = ssang_lieul-kieuk */
		{phonemes: [0x11D9,0x11F0], char: 0x11F9}, /* jongseong lieul-yeolin_hieuh + yesieung = yeolin_hieuh */
		{phonemes: [0x11EB,0x11AB], char: 0x11C8}, /* jongseong bansieus + nieun = nieun-bansieus */
		{phonemes: [0x11EB,0x11AF], char: 0x11D7}, /* jongseong bansieus + lieul = lieul-bansieus */
		{phonemes: [0x11EB,0x11B7], char: 0x11DF}, /* jongseong bansieus + mieum = mieum-bansieus */
		{phonemes: [0x11EB,0x11D9], char: 0xD7D7}, /* jongseong bansieus + lieul-yeolin_hieuh = ssang_lieul-kieuk */
		{phonemes: [0x11EB,0x11F0], char: 0x11F2}, /* jongseong bansieus + yesieung = yesieung-bansieus */
		{phonemes: [0x11F0,0x11BA], char: 0x11F1}, /* jongseong yesieung + sieus = yesieung-sieus */
		{phonemes: [0x11F0,0x11D9], char: 0x11F9}, /* jongseong yesieung + lieul-yeolin_hieuh = yeolin_hieuh */
		{phonemes: [0x11F0,0x11EB], char: 0x11F2} /* jongseong yesieung + bansieus = yesieung-bansieus */
	].concat(moachigi_combination_table_default);
	...
	K3_Semoe_moachigi_multikey_abbreviation_table = [
		...
		{keys: ['k','s','w'], chars: [0xAE4A,0xC740,0x20]}, /* 깊은  */
		{keys: [';','k','s','w'], chars: [0xAE4A,0xC740,0x20]}, /* 깊은  */
		...
		{keys: [';','e','j','k','w'], chars: [0xAC19,0xC774,0x20]}, /* 같이  */
		{keys: ['e','j','k','s','w'], chars: [0xAC19,0xC774,0x20]}, /* 같이  */
		{keys: [';','e','j','k','s','w'], chars: [0xAC19,0xC774,0x20]}, /* 같이  */
		{keys: [';','j','k','w'], chars: [0xAE4A,0xC774]}, /* 깊이 */
		{keys: ['j','k','s','w'], chars: [0xAE4A,0xC774]}, /* 깊이 */
		{keys: [';','j','k','s','w'], chars: [0xAE4A,0xC774]}, /* 깊이 */
		...
		{keys: ['f','g','j','k','z'], chars: [0xAC00,0xB054,0x20]}, /* 가끔  */
		...
		{keys: ['s','u','w'], chars: [0xB192,0xC774]}, /* 높이 */
		{keys: [';','s','u','w'], chars: [0xB192,0xC774]}, /* 높이 */
		...
		{keys: ['s','w','y'], chars: [0xBB34,0xB98E]}, /* 무릎 */
		{keys: [';','s','w','y'], chars: [0xBB34,0xB98E]}, /* 무릎 */
		...
		{keys: [';','e','o','q'], chars: [0xBC16,0xC5D0,0x20]}, /* 밖에  */
		...
		{keys: [';','a','e','o'], chars: [0xBD80,0xC5CC]}, /* 부엌 */
		{keys: [';','o','s','x'], chars: [0xBD80,0xC5CC]}, /* 부엌 */
		{keys: [';','e','o','q','x'], chars: [0xBD80,0xC5CC]}, /* 부엌 */
		{keys: ['a','e','o','s','z'], chars: [0xBD80,0xC5CC]}, /* 부엌 */
		{keys: ['b','f','o'], chars: [0xBC14,0xC704]}, /* 바위 */
		{keys: ['b','f','o','s'], chars: [0xD6C4,0xBC18]}, /* 후반 */
		...
		{keys: ['n','s','w'], chars: [0xC2F6,0xC740,0x20]}, /* 싶은  */
		{keys: [';','n','s','w'], chars: [0xC2F6,0xC740,0x20]}, /* 싶은  */
		...
		{keys: ['a','j','s'], chars: [0xC9C0,0x20,0xC54A]}, /* 지 않 */
		...
		{keys: ['b','f','l'], chars: [0xC790,0xC8FC,0x20]}, /* 자주  */
		{keys: ['b','f','l','s'], chars: [0xC804,0xBB38,0xAC00]}, /* 전문가 */
		...
		{keys: [';','j','l','q','w'], chars: [0xC80A,0xC740]}, /* 젊은 */
		{keys: ['j','l','q','s','w'], chars: [0xC80A,0xC740]}, /* 젊은 */
		{keys: [';','j','l','q','s','w'], chars: [0xC80A,0xC740]}, /* 젊은 */
		...
		{keys: ['a','h','i','s'], chars: [0xD1B5,0xC2E0]}, /* 통신 */
		{keys: ['e','h','i'], chars: [0xD65C,0xB3D9]}, /* 활동 */
		{keys: ['a','h','i','w'], chars: [0xD1B5,0xD569]}, /* 통합 */
		...
		{keys: ['.','i','u'], chars: [0xB610,0xB294,0x20]}, /* 또는 */
		{keys: ['i','u','v'], chars: [0xB610,0xB294,0x20]}, /* 또는  */
		{keys: ['.','a','i','u'], chars: [0xB3D9,0xB124]}, /* 동네 */
		...
		{keys: ['.','c','i','k'], chars: [0xACC4,0xB2E8]}, /* 계단 */
		{keys: ['c','i','k','v'], chars: [0xACC4,0xB2E8]}, /* 계단 */
		{keys: ['.','i','k'], chars: [0xAC80,0xD1A0]}, /* 검토 */
		{keys: ['i','k','v'], chars: [0xAC80,0xD1A0]}, /* 검토 */
		{keys: ['.','a','i','k'], chars: [0xACE0,0xD1B5]}, /* 고통 */
		{keys: ['a','i','k','v'], chars: [0xACE0,0xD1B5]}, /* 고통 */
		...
		{keys: ['.','a','i','k','v'], chars: [0xAD50,0xD1B5]}, /* 교통 */
		{keys: ['a','f','i','k','r'], chars: [0xAD50,0xD1B5]}, /* 교통 */
		...
		{keys: ['.','m','u'], chars: [0xB178,0xB798]}, /* 노래 */
		...
		{keys: ['e','f','o','y'], chars: [0xBD88,0xB9CC]}, /* 불만 */
		...
		{keys: [';','e','k','o','w'], chars: [0xBC14,0xAE65]}, /* 바깥 */
		{keys: ['e','k','o','s','w'], chars: [0xBC14,0xAE65]}, /* 바깥 */
		{keys: [';','e','k','o','s','w'], chars: [0xBC14,0xAE65]}, /* 바깥 */
		...
		{keys: ['.','k','o'], chars: [0xBCF4,0xACE0]}, /* 보고 */
		{keys: ['k','o','v'], chars: [0xBCF4,0xACE0]}, /* 보고 */
		{keys: ['.','k','o','x'], chars: [0xBCF8,0xACA9,0xC801]}, /* 본격적 */
		{keys: ['k','o','v','x'], chars: [0xBCF8,0xACA9,0xC801]}, /* 본격적 */
		{keys: ['.','k','o','s'], chars: [0xAE30,0xBCF8]}, /* 기본 */
		{keys: ['k','o','s','v'], chars: [0xAE30,0xBCF8]}, /* 기본 */
		{keys: ['.','a','k','o'], chars: [0xACF5,0xD3EC]}, /* 공포 */
		...
		{keys: ['f','i','o'], chars: [0xB2E4,0x2E,0x20]}, /* 다.  */
		...
		{keys: ['.','i','o'], chars: [0xBCF4,0xB2E4,0x20]}, /* 보다 */
		{keys: ['i','o','v'], chars: [0xBCF4,0xB2E4,0x20]}, /* 보다  */
		{keys: ['.','a','i','o','s'], chars: [0xBD80,0xB3D9,0xC0B0]}, /* 부동산 */
		{keys: ['a','i','o','s','v'], chars: [0xBD80,0xB3D9,0xC0B0]}, /* 부동산 */
		{keys: ['.','a','i','o'], chars: [0xBCF4,0xD1B5]}, /* 보통 */
		{keys: ['a','i','o','v'], chars: [0xBCF4,0xD1B5]}, /* 보통 */
		...
		{keys: ['.','b','i','o'], chars: [0xBD80,0xB3C4]}, /* 부도 */
		...
		{keys: ['n','o','q','w'], chars: [0x20,0xC218,0xBC16,0xC5D0,0x20,0xC5C6]}, /*  수밖에 없 */
		...
		{keys: ['.','n','o'], chars: [0xC18C,0xBE44]}, /* 소비 */
		...
		{keys: ['.','l','o'], chars: [0xC815,0xBCF4]}, /* 정보 */
		{keys: ['l','o','v'], chars: [0xC815,0xBCF4]}, /* 정보 */
		{keys: ['.','l','o','x'], chars: [0xBD81,0xCABD]}, /* 북쪽 */
		{keys: ['l','o','v','x'], chars: [0xBD81,0xCABD]}, /* 북쪽 */
		{keys: ['.','l','o','s'], chars: [0xC790,0xBCF8]}, /* 자본 */
		...
		{keys: ['.','o','u'], chars: [0xBCF4,0xB294,0x20]}, /* 보는 */
		...
		{keys: ['k','n','q','w'], chars: [0x20,0xC218,0xAC00,0x20,0xC5C6]}, /*  수가 없 */
		{keys: ['k','n','q'], chars: [0x20,0xC218,0xAC00,0x20,0xC788]}, /*  수가 있 */
		...
		{keys: ['.','c','k','n','s'], chars: [0xACC4,0xC0B0]}, /* 계산 */
		{keys: ['c','k','n','s','v'], chars: [0xACC4,0xC0B0]}, /* 계산 */
		{keys: ['.','k','n'], chars: [0xC0AC,0xACE0]}, /* 사고 */
		{keys: ['k','n','v'], chars: [0xC0AC,0xACE0]}, /* 사고 */
		{keys: ['.','k','n','x'], chars: [0xACC4,0xC18D]}, /* 계속 */
		{keys: ['k','n','v','x'], chars: [0xACC4,0xC18D]}, /* 계속 */
		{keys: ['.','k','n','s'], chars: [0xC190,0xAC00,0xB77D]}, /* 손가락 */
		{keys: ['k','n','s','v'], chars: [0xC190,0xAC00,0xB77D]}, /* 손가락 */
		{keys: ['.','e','k','n'], chars: [0xC2DC,0xACE8]}, /* 시골 */
		{keys: ['e','k','n','v'], chars: [0xC2DC,0xACE8]}, /* 시골 */
		{keys: ['.','k','n','z'], chars: [0xC18C,0xAE08]}, /* 소금 */
		{keys: ['k','n','v','z'], chars: [0xC18C,0xAE08]}, /* 소금 */
		{keys: ['.','a','k','n'], chars: [0xC131,0xACF5]}, /* 성공 */
		...
		{keys: ['n','q','u','w'], chars: [0x20,0xC218,0xB294,0x20,0xC5C6]}, /*  수는 없 */
		{keys: ['n','q','u'], chars: [0x20,0xC218,0xB294,0x20,0xC788]}, /*  수는 있 */
		...
		{keys: ['.','n','s','u'], chars: [0xC190,0xB2D8]}, /* 손님 */
		{keys: ['n','s','u','v'], chars: [0xC190,0xB2D8]}, /* 손님 */
		{keys: ['.','a','n','u'], chars: [0xB18D,0xC0AC]}, /* 농사 */
		...
		{keys: ['.','c','m','n'], chars: [0xC0AC,0xB840]}, /* 사례 */
		{keys: ['c','m','n','v'], chars: [0xC0AC,0xB840]}, /* 사례 */
		{keys: ['.','m','n'], chars: [0xB85C,0xC11C,0x20]}, /* 로서 */
		...
		{keys: ['n','q','y'], chars: [0x20,0xC218,0xB9CC,0x20,0xC788]}, /*  수만 있 */
		...
		{keys: ['.','n','y'], chars: [0xC18C,0xBB38]}, /* 소문 */
		{keys: ['n','v','y'], chars: [0xC18C,0xBB38]}, /* 소문 */
		{keys: ['.','n','x','y'], chars: [0xBB3C,0xC18D]}, /* 물속 */
		{keys: ['n','v','x','y'], chars: [0xBB3C,0xC18D]}, /* 물속 */
		{keys: ['.','n','w','y'], chars: [0xBAB9,0xC2DC,0x20]}, /* 몹시 */
		...
		{keys: ['.','h','n'], chars: [0xCCAD,0xC18C]}, /* 청소 */
		{keys: ['h','n','v'], chars: [0xCCAD,0xC18C]}, /* 청소 */
		{keys: ['.','h','n','x'], chars: [0xD639,0xC2DC,0x20]}, /* 혹시 */
		...
		{keys: ['c','f','h','n'], chars: [0xC790,0xC138,0xD788,0x20]}, /* 자세히  */
		...
		{keys: ['.','l','n'], chars: [0xC870,0xC0AC]}, /* 조사 */
		{keys: ['l','n','v'], chars: [0xC870,0xC0AC]}, /* 조사 */
		{keys: ['.','l','n','x'], chars: [0xC9C0,0xC18D]}, /* 지속 */
		{keys: ['l','n','v','x'], chars: [0xC9C0,0xC18D]}, /* 지속 */
		{keys: ['.','a','l','n'], chars: [0xC7A5,0xC18C]}, /* 장소 */
		...
		{keys: ['.','b','l','n'], chars: [0xC18C,0xC8FC]}, /* 소주 */
		...
		{keys: ['.','h','j'], chars: [0xC624,0xD788,0xB824,0x20]}, /* 오히려 */
		{keys: ['h','j','v'], chars: [0xC624,0xD788,0xB824,0x20]}, /* 오히려  */
		{keys: ['.','h','j','x'], chars: [0xD639,0xC740,0x20]}, /* 혹은 */
		{keys: ['h','j','v','x'], chars: [0xD639,0xC740,0x20]}, /* 혹은  */
		{keys: ['.','a','h','j'], chars: [0xD1B5,0xC77C]}, /* 통일 */
		{keys: ['a','h','j','v'], chars: [0xD1B5,0xC77C]}, /* 통일 */
		...
		{keys: ['h','j','r','s','v'], chars: [0xC6D0,0xD55C]}, /* 원한 */
		...
		{keys: ['h','j','r','t'], chars: [0xC5EC,0xC804,0xD788,0x20]}, /* 여전히  */
		...
		{keys: ['j','q','u'], chars: [0xC788,0xB294,0x20]}, /* 있는  */
		{keys: ['a','j','u'], chars: [0xB0B4,0xC6A9]}, /* 내용 */
		{keys: ['f','j','u'], chars: [0xC544,0xB2C8]}, /* 아니 */
		...
		{keys: ['.','j','u'], chars: [0xC624,0xB298]}, /* 오늘 */
		{keys: ['j','u','v'], chars: [0xC624,0xB298]}, /* 오늘 */
		{keys: ['.','j','s','u'], chars: [0xB17C,0xC758]}, /* 논의 */
		{keys: ['j','s','u','v'], chars: [0xB17C,0xC758]}, /* 논의 */
		{keys: ['.','a','j','u'], chars: [0xB18D,0xC5C5]}, /* 농업 */
		...
		{keys: ['.','c','k','l'], chars: [0xCCB4,0xACC4]}, /* 체계 */
		{keys: ['c','k','l','v'], chars: [0xCCB4,0xACC4]}, /* 체계 */
		{keys: ['.','k','l'], chars: [0xCD5C,0xACE0]}, /* 최고 */
		{keys: ['k','l','v'], chars: [0xCD5C,0xACE0]}, /* 최고 */
		{keys: ['.','k','l','x'], chars: [0xAC00,0xC871]}, /* 가족 */
		{keys: ['k','l','v','x'], chars: [0xAC00,0xC871]}, /* 가족 */
		{keys: ['.','k','l','s'], chars: [0xAE30,0xC874]}, /* 기존 */
		{keys: ['k','l','s','v'], chars: [0xAE30,0xC874]}, /* 기존 */
		{keys: ['.','a','k','l','s'], chars: [0xC8FC,0xC778,0xACF5]}, /* 주인공 */
		{keys: ['a','k','l','s','v'], chars: [0xC8FC,0xC778,0xACF5]}, /* 주인공 */
		{keys: ['.','a','k','l'], chars: [0xAC01,0xC885]}, /* 각종 */
		...
		{keys: ['k','l','r','s','v'], chars: [0xC815,0xAD8C]}, /* 정권 */
		{keys: ['b','c','k','l','x'], chars: [0xAD6D,0xC81C]}, /* 국제 */
		{keys: ['c','d','k','l'], chars: [0xCE58,0xAC8C,0x20]}, /* 치게  */
		...
		{keys: ['a','d','k','l','z'], chars: [0xAE40,0xC815]}, /* 김정 */
		{keys: ['d','k','l','z'], chars: [0xAE40,0xCE58]}, /* 김치 */
		...
		{keys: ['.','l','u','x'], chars: [0xB0A8,0xCABD]}, /* 남쪽 */
		...
		{keys: ['.','h','s','u'], chars: [0xB18D,0xCD0C]}, /* 농촌 */
		...
		{keys: ['a','i','m','s'], chars: [0xC624,0xB7AB,0xB3D9,0xC548]}, /* 오랫동안 */
		{keys: ['e','i','m'], chars: [0xB2EC,0xB9AC]}, /* 달리 */
		{keys: ['a','i','m'], chars: [0xB300,0xD1B5,0xB839]}, /* 대통령 */
		...
		{keys: ['.','i','m'], chars: [0xB530,0xB85C,0x20]}, /* 따로 */
		{keys: ['i','m','v'], chars: [0xB530,0xB85C,0x20]}, /* 따로  */
		{keys: ['.','i','m','s'], chars: [0xD1A0,0xB860]}, /* 토론 */
		{keys: ['i','m','s','v'], chars: [0xD1A0,0xB860]}, /* 토론 */
		{keys: ['.','a','i','m'], chars: [0xB3D9,0xB8CC]}, /* 동료 */
		{keys: ['a','i','m','v'], chars: [0xB3D9,0xB8CC]}, /* 동료 */
		{keys: ['.','f','i','m'], chars: [0xB77C,0xB3C4,0x20]}, /* 라도 */
		...
		{keys: ['i','n','q','w'], chars: [0x20,0xC218,0xB3C4,0x20,0xC5C6]}, /*  수도 없 */
		{keys: ['i','n','q'], chars: [0x20,0xC218,0xB3C4,0x20,0xC788]}, /*  수도 있 */
		...
		{keys: ['.','i','n'], chars: [0xB3C4,0xC2DC]}, /* 도시 */
		{keys: ['i','n','v'], chars: [0xB3C4,0xC2DC]}, /* 도시 */
		{keys: ['.','a','i','n'], chars: [0xB3D9,0xC2DC]}, /* 동시 */
		...
		{keys: ['i','l','r','s'], chars: [0xC804,0xD1B5]}, /* 전통 */
		{keys: ['a','i','l','r'], chars: [0xC815,0xB2F9]}, /* 정당 */
		{keys: ['i','l','r','s','x'], chars: [0xC804,0xD1B5,0xC801]}, /* 전통적 */
		{keys: ['c','i','l'], chars: [0xC81C,0xB3C4]}, /* 제도 */
		{keys: ['.','a','c','i','l'], chars: [0xD1B5,0xC81C]}, /* 통제 */
		{keys: ['a','c','i','l','v'], chars: [0xD1B5,0xC81C]}, /* 통제 */
		{keys: ['.','i','l'], chars: [0xD1A0,0xC9C0]}, /* 토지 */
		{keys: ['i','l','v'], chars: [0xD1A0,0xC9C0]}, /* 토지 */
		{keys: ['.','i','l','x'], chars: [0xB3D9,0xCABD]}, /* 동쪽 */
		...
		{keys: ['.','c','k','m'], chars: [0xB86D,0xAC8C,0x20]}, /* 롭게 */
		{keys: ['c','k','m','v'], chars: [0xB86D,0xAC8C,0x20]}, /* 롭게  */
		{keys: ['.','k','m'], chars: [0xADF8,0xB9AC,0xACE0,0x20]}, /* 그리고 */
		{keys: ['k','m','v'], chars: [0xADF8,0xB9AC,0xACE0,0x20]}, /* 그리고  */
		{keys: ['.','k','m','x'], chars: [0xAE30,0xB85D]}, /* 기록 */
		{keys: ['k','m','v','x'], chars: [0xAE30,0xB85D]}, /* 기록 */
		{keys: ['.','k','m','s'], chars: [0xACB0,0xB860]}, /* 결론 */
		...
		{keys: ['k','m','r','s','v'], chars: [0xAD8C,0xB9AC]}, /* 권리 */
		...
		{keys: ['.','m','y'], chars: [0xBAA8,0xB798]}, /* 모래 */
		{keys: ['m','v','y'], chars: [0xBAA8,0xB798]}, /* 모래 */
		{keys: ['.','e','m','y'], chars: [0xBAB0,0xB798,0x20]}, /* 몰래 */
		...
		{keys: ['.','m','o'], chars: [0xBC14,0xB85C,0x20]}, /* 바로 */
		{keys: ['m','o','v'], chars: [0xBC14,0xB85C,0x20]}, /* 바로  */
		{keys: ['.','m','o','x'], chars: [0xD3ED,0xB825]}, /* 폭력 */
		{keys: ['m','o','v','x'], chars: [0xD3ED,0xB825]}, /* 폭력 */
		{keys: ['.','m','o','s'], chars: [0xBCF8,0xB798]}, /* 본래 */
		...
		{keys: ['.','c','l','m'], chars: [0xCC28,0xB840]}, /* 차례 */
		{keys: ['c','l','m','v'], chars: [0xCC28,0xB840]}, /* 차례 */
		{keys: ['.','l','m','x'], chars: [0xC624,0xB978,0xCABD]}, /* 오른쪽 */
		{keys: ['l','m','v','x'], chars: [0xC624,0xB978,0xCABD]}, /* 오른쪽 */
		{keys: ['.','a','l','m'], chars: [0xCD1D,0xB9AC]}, /* 총리 */
		...
		{keys: ['.','c','l','y'], chars: [0xC81C,0xBAA9]}, /* 제목 */
		{keys: ['c','l','v','y'], chars: [0xC81C,0xBAA9]}, /* 제목 */
		{keys: ['.','l','x','y'], chars: [0xBAA9,0xC801]}, /* 목적 */
		...
		{keys: ['.','j','m'], chars: [0xC624,0xB798]}, /* 오래 */
		{keys: ['j','m','v'], chars: [0xC624,0xB798]}, /* 오래 */
		{keys: ['.','e','j','m'], chars: [0xC62C,0xB77C]}, /* 올라 */
		...
		{keys: ['j','m','r','s','v'], chars: [0xC6D0,0xB9AC]}, /* 원리 */
		{keys: ['.','b','j','m'], chars: [0xC778,0xB958]}, /* 인류 */
